<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue/Config/helpDocument.html";i:1509706256;s:28:"template/adminblue/base.html";i:1510977514;s:45:"template/adminblue/controlCommonVariable.html";i:1506689788;s:32:"template/adminblue/urlModel.html";i:1504865856;s:34:"template/adminblue/pageCommon.html";i:1505550038;s:34:"template/adminblue/openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	...
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/config/adddocument'); ?>';">添加帮助内容</button>
</div>
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td><input type="number" min="0" value="'+ data["data"][i]["sort"]+'" class="num input-common" onchange="updateDocument('+data["data"][i]["id"]+','+i+','+data["data"][i]["class_id"]+')" id="sort'+i+'"></td>';
					html += '<td><input type="text" id="title'+i+'" value="' + data["data"][i]["title"]+ '"onchange="updateDocument('+data["data"][i]["id"]+','+i+','+data["data"][i]["class_id"]+')" class="input-common" /></td>';
