<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue/Member/addMemberLevel.html";i:1505901604;s:28:"template/adminblue/base.html";i:1510977514;s:45:"template/adminblue/controlCommonVariable.html";i:1506689788;s:32:"template/adminblue/urlModel.html";i:1504865856;s:34:"template/adminblue/pageCommon.html";i:1505550038;s:34:"template/adminblue/openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd class="total">
			<div>
				<input type="checkbox" value="1" />累计积分满&nbsp;&nbsp;&nbsp;
				<input class="input-common" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="number" min="0" id="min_integral" style="margin-bottom: 0px; " placeholder="0">分&nbsp;&nbsp;&nbsp;
				<span class="hint">设置会员等级所需要的累计积分且必须大于等于0</span>
			</div>
			<div>
				<input type="checkbox" value="2" />消费额度满&nbsp;&nbsp;&nbsp;
				<input class="input-common" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="number" min="0" id="quota" style="margin-bottom: 0px; " placeholder="0">元&nbsp;&nbsp;&nbsp;
...
function addGift(){
	...
	$.ajax({
		...
		success : function(data) {
			if (data["code"] > 0) {
				showMessage('success', data["message"],"<?php echo __url('ADMIN_MAIN/member/memberlevellist'); ?>");
			}else{
