<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue/Config/userNotice.html";i:1508414186;s:28:"template/adminblue/base.html";i:1510977514;s:45:"template/adminblue/controlCommonVariable.html";i:1506689788;s:32:"template/adminblue/urlModel.html";i:1504865856;s:34:"template/adminblue/pageCommon.html";i:1505550038;s:34:"template/adminblue/openDialog.html";i:1509523954;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	...
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/config/addHomeNotice'); ?>';">添加首页公告</button>
</div>
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td>'+data["data"][i]["notice_title"]+'</td>';
